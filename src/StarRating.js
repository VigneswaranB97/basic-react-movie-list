...
export default function StarRating({
  ...
  const [tempSelectedRating, setTempSelectedRating] = useState(defaultRating);
...
function Star({ full, onStarClick, onHoverIn, onHoverOut, color, size }) {
  const starStyle = {
    width: `${size}px`,
    height: `${size}px`,
    display: "block",
